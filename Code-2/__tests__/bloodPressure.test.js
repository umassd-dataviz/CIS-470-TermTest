...
describe('BloodPressure Function Tests', () => {
	...
	describe('Decision Table', () => {
		test('140 <= systolic < 160', () => {
			expect(BloodPressure("John Doe", 35, 150, 80)).toEqual('STAGE_1_HBP');
		});
		test("160 <= systolic < 180", () => {
			expect(BloodPressure("John Doe", 35, 170, 80)).toEqual("STAGE_2_HBP");
		});
		test("90 <= diastolic < 100", () => {
			expect(BloodPressure("John Doe", 35, 100, 95)).toEqual("STAGE_1_HBP");
		});
		test("100 <= diastolic <= 110", () => {
			expect(BloodPressure("John Doe", 35, 110, 105)).toEqual("STAGE_2_HBP");
		});
	});
});
